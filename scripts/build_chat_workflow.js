        ...
        // 5. Single tool: dispatcher subworkflow
        {
            parameters: {
                ...
                workflowInputs: {
                    ...
                    value: {
                        tool: "={{ $fromAI('tool', 'Acción: search, transactions, revenue, top_products, product_daily, open_days o list', 'string') }}",
