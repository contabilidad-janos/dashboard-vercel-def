...
- tool="top_products", bu_name="<BU>", start_date="YYYY-MM-DD", end_date="YYYY-MM-DD", limit_n=10: top N products by revenue in that BU during the range. Works for "Juntos house", "Juntos boutique", "Picadeli" / "Juntos deli", "Tasting place", "Juntos farm shop", "Distribution b2b" (all have article-level data now). Product revenue is NET (VAT-exc). Only "Activities" and "Juntos Products" lack a product breakdown.
