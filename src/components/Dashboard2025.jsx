...
const Dashboard2025 = () => {
    ...
    }, [selectedUnit, salesData, salesData24, businessUnits, budgetData]);
    ...
    const updateView = (unit) => {
        ...
        if (unit === 'all') {
            ...
            // Aggregate 2024
            if (salesData24) {
                currentSales24 = MONTHS.map((_, i) => businessUnits.reduce((sum, b) => sum + (salesData24[b.name][i] || 0), 0));
            }
            ...
            currentSales24 = salesData24 ? (salesData24[unit] || []) : [];
