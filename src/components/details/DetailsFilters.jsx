...
const DetailsFilters = ({
    ...
    const renderPillToggle = (checked, onChange, label, disabled) => (
        <button
    ...
    return (
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm mb-6">
            ...
            <div className="flex flex-wrap items-center gap-3 px-5 py-3 border-b border-gray-100 bg-gray-50/50">
                ...
                {renderPillToggle(compare24, setCompare24, `vs '${selectedYear === '2026' ? '25' : '24'}`, isYearly)}
                {renderPillToggle(includeVat, setIncludeVat, "Inc. VAT", false)}
                {renderPillToggle(compareBudget, setCompareBudget, "vs Budget", isYearly || metric !== 'sales')}
            </div>
